...
export default class SimpleExpansionPanel extends Component {
  ...
  {
   return (
    <div><div style={{paddingTop: '90px',paddingRight: '680px',fontSize: '40px'}}>POPULAR QUERIES</div><center><div style={{width: '70%',paddingTop: '40px',paddingBottom: '80px'}}>
      <ExpansionPanel>
        <ExpansionPanelSummary
          expandIcon={<ExpandMoreIcon />}
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>Do I have to return the car to the same location where I picked it up?</Typography>
        </ExpansionPanelSummary>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>How do I unlock my car?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>Where can I find the Car Keys?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          id="panel2a-header">
          <Typography>Can someone else drive Kiraye-Car during my reservation? What is the process to add co-driver?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>How do I end my reservation?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>How will I receive my Refund?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>In case of  Doorstep service who will deliver the car?What if the delivery guy comes late?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>How long do refunds take?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>How do I reach the location of the car?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>How do I find my car?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>How do I proceed with my Start Checklist after reaching the location?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>I reached my location back, how do I proceed with my End Checklist?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
          "Location without fleet (KLE booking): Filling checklists is easy! Now you can fill your End checklist via the Zoomcar app. Just log in to the App, select your live booking from the My bookings page and start. 1. Keep the keys inside the dashboard. 2. Edit your checklist details if there are any changes with Images. 3. Lock the vehicle. 4. End of your trip by uploading 4 side images of the vehicle. It is advised to keep the images for your future reference and need proper network coverage filling the checklist."
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>What if my Driving License is  in not yet Approved/ Review in progress state?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>How do I extend my booking end time?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>What would be the fuel level in the vehicle which gets allotted to me? What if the fuel level is low?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>How do I track my free KM reading?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>What if I see there are exterior damages on the vehicle?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>How should I pay the outstanding amount on a booking?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>When will I get my security deposit refunded back?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>what is there is an outstanding amount against my previous booking pending?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>When will I get to know the exact vehicle details?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="panel1a-content"
          id="panel1a-header">
          <Typography>What are excess KMs charges?</Typography>
        </ExpansionPanelSummary>
        <div style={{backgroundColor:'silver'}}><ExpansionPanelDetails>
          <Typography>
